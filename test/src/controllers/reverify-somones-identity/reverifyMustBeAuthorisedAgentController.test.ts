...
import { REVERIFY_BASE_URL, REVERIFY_MUST_BE_AUTHORISED_AGENT } from "../../../../src/types/pageURL";
import * as localise from "../../../../src/utils/localise";

const router = supertest(app);

describe("GET" + REVERIFY_MUST_BE_AUTHORISED_AGENT, () => {
    it("should render the must be authorised agent page with status 200 and display the information on the screen", async () => {
        const res = await router.get(REVERIFY_BASE_URL + REVERIFY_MUST_BE_AUTHORISED_AGENT);
