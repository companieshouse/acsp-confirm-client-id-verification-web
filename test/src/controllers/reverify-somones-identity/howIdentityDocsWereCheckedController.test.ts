...
import { REVERIFY_HOW_IDENTITY_DOCUMENTS_CHECKED, REVERIFY_BASE_URL, REVERIFY_WHICH_IDENTITY_DOCS_CHECKED_GROUP2, REVERIFY_WHICH_IDENTITY_DOCS_CHECKED_GROUP1, REVERIFY_CHECK_YOUR_ANSWERS, REVERIFY_WHEN_IDENTITY_CHECKS_COMPLETED } from "../../../../src/types/pageURL";
...
describe("POST" + REVERIFY_HOW_IDENTITY_DOCUMENTS_CHECKED, () => {
    ...
    it("should return status 400 with client data firstName and lastName when validation fails", async () => {
        customMockSessionMiddleware = sessionMiddleware as jest.Mock;
        const session = getSessionRequestWithPermission();
        ...
        session.setExtraData(PREVIOUS_PAGE_URL, REVERIFY_BASE_URL + REVERIFY_WHEN_IDENTITY_CHECKS_COMPLETED + "?lang=en");
