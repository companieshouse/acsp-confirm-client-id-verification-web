...
import { REVERIFY_BASE_URL, REVERIFY_WHICH_IDENTITY_DOCS_CHECKED_GROUP1, REVERIFY_HOW_IDENTITY_DOCUMENTS_CHECKED, REVERIFY_ENTER_ID_DOCUMENT_DETAILS } from "../../types/pageURL";
