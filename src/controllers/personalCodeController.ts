...
import { BASE_URL, PERSONAL_CODE, EMAIL_ADDRESS, PERSONS_NAME_ON_PUBLIC_REGISTER } from "../types/pageURL";
...
export const get = (req: Request, res: Response, next: NextFunction) => {
    ...
    res.render(config.PERSONAL_CODE, {
        previousPage: addLangToUrl(BASE_URL + PERSONS_NAME_ON_PUBLIC_REGISTER, lang),
